...
if __name__ == '__main__':
    ...
    parser.add_argument("--experiments_dir", type=str, default="experiments/batch_128/textnoise/self-attention/", help="Directory where trained models will be saved")
