...
from transformers.beam_constraints import DisjunctiveConstraint, PhrasalConstraint
from transformers.beam_search import BeamScorer, BeamSearchScorer, ConstrainedBeamSearchScorer
...
from transformers.stopping_criteria import (
    MaxLengthCriteria,
    MaxTimeCriteria,
    StoppingCriteria,
