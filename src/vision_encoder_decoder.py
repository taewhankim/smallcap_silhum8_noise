...
class SmallCap(PreTrainedModel):
    ...
    def forward(
        ...
        encoder_outputs = self.cross_att(
            hidden_states=encoder_outputs,
            encoder_hidden_states=None) # template_noise_feat
    ...
    def prepare_inputs_for_generation(
        ...
        # decoder_inputs = self.decoder.prepare_inputs_for_generation(input_ids, past_key_values=past,use_cache=True)
        decoder_inputs = self.prepare_inputs_for_generation2(input_ids, past_key_values=past)
    ...
    def prepare_inputs_for_generation2(self, input_ids, past_key_values=None, inputs_embeds=None, **kwargs):
